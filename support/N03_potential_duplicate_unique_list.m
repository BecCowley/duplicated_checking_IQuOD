%%% In the N02 step, we  searched for many potential duplicate files, now we need to merge the file pairs
%%% Merge multiple txt files into one large txt file to ensure the uniqueness of the filename
clear
clc
...
fid=fopen(['./potential_duplicate_ALL_',num2str(year),'_unique.txt'],'w+');
%%% Output filename
