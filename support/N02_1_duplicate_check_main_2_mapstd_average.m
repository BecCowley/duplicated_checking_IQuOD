%%% Using mapstd standardize each line of data, calculate the arithmetic average of each line, and then compare which is closer
...
for nian=1:length(flist)
    ...
    DNA_mapped=standardizeData(DNA_series_copy',0,1);
